...
insert  into `alternativas`(`idalternativas`,`alternativa`,`pregunta_idPregunta`,`tipo`) values (1,' A) Secuencia temporal.',1,'OPCION'),(2,' B) Comparación.',1,'OPCION'),(3,' C) Problema – solución.',1,'OPCION'),(4,' D) Descriptivo.',1,'CORRECTA'),(5,' E) Causa – efecto.',1,'OPCION'),(6,'A) discusión.',2,'OPCION'),(7,'B) foro. ',2,'OPCION'),(8,'C) debate. ',2,'CORRECTA'),(9,'D) conversación. ',2,'OPCION'),(10,'E) mesa redonda. ',2,'OPCION'),(11,'A) Informar',3,'OPCION'),(12,'B) Persuadir',3,'OPCION'),(13,'C) Convencer',3,'CORRECTA'),(14,'D) Narrar un hecho',3,'OPCION'),(15,'E) Presentar un problema ',3,'OPCION'),(16,'A) Anáfora',4,'OPCION'),(17,'B) Comparación',4,'OPCION'),(18,'C) Metáfora ',4,'OPCION'),(19,'D) Personificación',4,'CORRECTA'),(20,'E) Hipérbole ',4,'OPCION'),(21,'A) flash-back.',5,'CORRECTA'),(22,'B) anticipación.',5,'OPCION'),(23,'C) prolepsis. ',5,'OPCION'),(24,'D) montaje',5,'OPCION'),(25,'E) anacronía. ',5,'OPCION'),(26,'A) Se utilizan fechas, lugares y datos concretos. ',6,'OPCION'),(27,'B) El mundo representado es contemporáneo al del lector.',6,'OPCION'),(28,'C) Se describen detalladamente lugares y personajes. ',6,'OPCION'),(29,'D) Los hechos representados han ocurrido históricamente',6,'CORRECTA'),(30,'E) La lógica de lo representado no escapa de lo habitual. ',6,'OPCION'),(31,'A) abundancia de entrevistas a los involucrados directos. ',7,'OPCION'),(32,'B) reproducción de las palabras del reportero. ',7,'OPCION'),(33,'C) brevedad de la información entregada.',7,'OPCION'),(34,'D) menor tiempo entre la ocurrencia del hecho y su difusión noticiosa. ',7,'CORRECTA'),(35,'E) exposición a cargo de dos presentadores expertos en el tema. ',7,'OPCION'),(41,'A) El protagonista lucha contra un destino inexorable.',8,'OPCION'),(42,'B) Se origina como agradecimiento a los dioses del Olimpo. ',8,'CORRECTA'),(43,'C) Su desenlace es inesperado.',8,'OPCION'),(44,'D) Tiene cinco actos y el Coro es personaje protagónico. ',8,'OPCION'),(45,'E) El protagonista siempre muere.',8,'OPCION'),(46,'A) Los ojos de Guillermina, como dos luceros, llegaron hasta el fondo de mi alma',9,'CORRECTA'),(47,'B) Entonces entró Guillermina, con dos relámpagos azules que me atravesaron el  alma.',9,'OPCION'),(48,'C) La mirada dulce de Guillermina entró por la ventana y me llevó al cielo',9,'OPCION'),(49,'D) Mis ojos se volvieron más azules que el cielo cuando entró Guillermina y me  cautivó.',9,'OPCION'),(50,'E) Había fuego en los ojos de Guillermina y me hundí en su mirada como ahogado  en el mar. ',9,'OPCION'),(51,'A) acceder a un grupo específico de receptores',10,'OPCION'),(52,'B) formalizar el trato hacia los receptores del mensaje.',10,'OPCION'),(53,'C) propiciar una comunicación clara y comprensible.',10,'OPCION'),(54,'D) representar una imagen idealizada de los consumidores.',10,'OPCION'),(55,'E) lograr la identificación entre el receptor y el producto. ',10,'CORRECTA');
